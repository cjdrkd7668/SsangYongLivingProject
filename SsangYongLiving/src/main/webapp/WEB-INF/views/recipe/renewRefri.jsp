...
<div class="recipe-grid-container" id="renew-refri">
	...
	<div class="recipe-gbox recipe-gbox-two">
		...
		<h2>내 가상 냉장고</h2>
		<p>가상 냉장고에 담긴 재료와 수량입니다.<br>
		특정 재료를 선택해서, 최대 수량만큼 뺄 수 있습니다. </p>
		
		<div class="recipe-cart" style="background: #C8EBFA;">
		
			<div class="recipe-ingre-item recipe-ingre-refri">
			...
			<div class="recipe-ingre-item recipe-ingre-refri">
				<img src="/living/resources/images/ingredient-leeks.png">
				<div>대파</div>
				<div>2 <span>단</span></div>
			</div>
			<div class="recipe-ingre-item recipe-ingre-refri">
				<img src="/living/resources/images/ingredient-bacon.png">
				<div>베이컨</div>
				<div>22 <span>장</span></div>
			</div>
		...
		<div class="modal fade" id="remove-ingre-g" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
					...
					<div class="modal-body">
			            <label for="etc-text" class="control-label">뺄 재료의 용량을 선택해주세요 :</label>
			            <div class="slider-ingre">
  							<input type="range" min="0" max="2000" step="50" value="200" class="slider range-ingre">
						</div>
						<span>200</span>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">취소하기</button>
						<button type="button" class="btn btn-primary">빼기</button>
					</div>
				</div>
			</div>
		</div>		
		
		<div class="modal fade" id="remove-ingre-nong" tabindex="-1" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
					...
					<div class="modal-body">
			            <label for="etc-text" class="control-label">뺄 재료의 수량을 선택해주세요 :</label>
			            <div class="slider-ingre">
  							<input type="range" min="1" max="20" value="10" class="slider range-ingre">
						</div>
						<span>10</span>
	...
	<div class="recipe-gbox recipe-gbox-three">
		...
		<h2>고수들의 레시피</h2>
		<p>현재 냉장고의 재료로 만들 수 있는 레시피들입니다.<br>
...
<script>
	...
	$('.recipe-ingre-refri').click(function() {
		if ($(this).children().last().children().eq(0).text() == 'g') {
			$('#remove-ingre-g').modal('show')
		} else {			
			$('#remove-ingre-nong').modal('show')
		}
	})
